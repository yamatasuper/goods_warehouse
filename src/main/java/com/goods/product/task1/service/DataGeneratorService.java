    ...
    for (int i = start; i < start + batchSize; i++) {
      ...
      batchArgs.add(
          new Object[] {
            ...
            currency,
            0,
            true // Новое поле is_available
          });
    }

    String sql =
        "INSERT INTO product (name, sku, description, category, price, quantity, last_quantity_update, created_at, currency, version, is_available) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
